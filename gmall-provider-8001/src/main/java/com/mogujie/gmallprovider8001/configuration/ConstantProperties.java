package com.mogujie.gmallprovider8001.configuration;
...
public class ConstantProperties implements InitializingBean {
    ...
    public String toString() {
        return "ConstantProperties{" +
                "java4all_file_endpoint='" + java4all_file_endpoint + '\'' +
                ", java4all_file_keyid='" + java4all_file_keyid + '\'' +
                ", java4all_file_keysecret='" + java4all_file_keysecret + '\'' +
                ", java4all_file_filehost='" + java4all_file_filehost + '\'' +
                ", java4all_file_bucketname1='" + java4all_file_bucketname1 + '\'' +
                '}';
    }
}